package com.libraryai.backend.controller.admin;
...
import com.libraryai.backend.service.admin.AdminService;
...
public class AdminController {
    ...
    /**
     * Crea un plan nuevo desde el panel administrativo.
     */
    public static HttpHandler createPlan() {
        return exchange -> {
            ApiRequest request = new ApiRequest(exchange);
            String body = request.readBody();
            ...
            JsonObject response = AdminService.createPlan(payload);
            int statusCode = response.get("status").getAsInt();
            response.remove("status");
            ApiResponse.send(exchange, response.toString(), statusCode);
        };
    ...
    /**
     * Actualiza un plan ya existente del catálogo.
     */
    public static HttpHandler updatePlan() {
        return exchange -> {
            String query = exchange.getRequestURI().getQuery();
            ...
            JsonObject payload = new Gson().fromJson(body, JsonObject.class);
            JsonObject response = AdminService.updatePlan(idJson.get("id").getAsInt(), payload);
            int statusCode = response.get("status").getAsInt();
            response.remove("status");
            ApiResponse.send(exchange, response.toString(), statusCode);
        };
    ...
    public static HttpHandler updateUserSubscription() {
        return exchange -> {
            ...
            JsonObject payload = new Gson().fromJson(body, JsonObject.class);
            JsonObject response = AdminService.updateUserSubscription(idJson.get("id").getAsInt(), payload);
            int statusCode = response.get("status").getAsInt();
            response.remove("status");
            ApiResponse.send(exchange, response.toString(), statusCode);
        };
